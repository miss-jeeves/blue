...
Gem::Specification.new do |s|
  ...
  s.files = ["Gemfile", "Gemfile.lock", "LICENSE", "Rakefile", "README.rdoc", "lib/factory_girl_rails/railtie.rb", "lib/factory_girl_rails.rb", "features/load_definitions.feature", "features/step_definitions/rails_steps.rb", "features/support/env.rb"]
